...
A multi-agent collaborative quest game that demonstrates autonomous agent orchestration using [Scion](https://github.com/Googlecloudplatform/scion). Five AI characters with distinct specializations work together - guided by a Game Runner (Dungeon Master) agent - to solve computational challenges, recover lost knowledge fragments, and restore an ancient artifact.
